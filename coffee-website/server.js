...
app.post("/confirm-order", async (req, res) => {
  ...
  // ❌ CANCEL ORDER ENDPOINT (ADD HERE)
app.post("/cancel-order", async (req, res) => {
  ...
  const cancelMail = {
    from: "mona.dhameja2005@gmail.com",
    to: email,
    subject: "❌ Your Coffee Bliss Order Cancelled",
    html: `
      <h2>Hi,</h2>
      <p>Your order has been <b>cancelled successfully</b>.</p>
      <p>If this was a mistake, feel free to order again ☕</p>
      <p>Regards,<br>Coffee Bliss Team</p>
    `
  };

  try {
    await transporter.sendMail(cancelMail);
