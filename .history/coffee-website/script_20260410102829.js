...
const menuItems = [
  ...
  { name: "Sandwich", price: 130, img: "images/sandwich.jpg", category: "snacks" },
  ...
  { name: "Cheese Toast", price: 90, img: "images/cheesetoast.jpg", category: "snacks" }
];
...
function cancelLastOrder() {
  ...
  // IMPORTANT: keep email before clearing
...
function startOrderTracking() {
  ...
  setTimeout(() => {
    statusEl.innerText = "🚚 Out for delivery...";
  }, 5000);
...
if (data.success) {
  ...
  // ✅ Store last order for cancellation
  lastOrder = [...cart];
  orderTime = new Date();
  ...
  // ✅ Show cancel option + start tracking
  showCancelOption();
  startOrderTracking();
